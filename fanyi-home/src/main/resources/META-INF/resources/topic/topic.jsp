...
<div class="ui container" style="margin-top:0px;">
	<c:forEach var="topic" items="${topics}">
		<div>${topic.id} - ${topic.userId} - ${topic.title} - ${topic.content} <a href="${cxt_path }/topic/edit/${topic.id}">edit</a>|<a href="${cxt_path }/topic/delete/${topic.id}">delete</a></div>
	</c:forEach>
	<a href="${cxt_path }/topic/add">add</a>
</div>
