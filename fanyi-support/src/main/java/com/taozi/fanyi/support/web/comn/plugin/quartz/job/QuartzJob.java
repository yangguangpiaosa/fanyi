package com.taozi.fanyi.support.web.comn.plugin.quartz.job;
...
import com.taozi.fanyi.support.web.comn.plugin.quartz.QuartzKey;
import com.taozi.fanyi.support.web.comn.plugin.quartz.QuartzKit;
	...
	public void stop() {
		...
		try {
			if (factory != null) {
				...
				TriggerKey triggerKey = TriggerKey.triggerKey(TRIGGER_MARK
						+ SEPARATOR + name + SEPARATOR + id, GROUP_MARK
						+ SEPARATOR + group + SEPARATOR + id);
